                            ...
                            <div class="col-md-8">
                                <div class="blog_fashion_left">
                                    <div class="blog_fashion_img">
                                        <img src="./Resources/images/fashion-img1.jpg" alt="" />
                                    </div>
                            ...
                            <div class="col-md-4">
                                <div class="blog_fashion_right">
                                    <div class="fashion_test text-center">
                                        <img class="img-circle" src="./Resources/images/blog-test-img1.jpg" alt="" />
                                        ...
                                        <img class="m-top-20" src="./Resources/images/blog-sign.png" alt="" />
                                    </div>
                    ...
                    <div class="row">
                        <div class="blog_area fix">
                            ...
                            <div class="col-md-4">
                                <div class="blog_item m-top-30">
                                    <div class="blog_item_img">
                                        <img src="./Resources/images/blog/4.jpg" alt="" />
                                    </div>
                                    <ol class="breadcrumb">
                                        <li><a href="#" class="text-black">Fashion</a></li>
                                        <li><a href="#" class="text-black">Feb 28th 2015</a></li>
                            ...
                            <div class="col-md-4">
                                <div class="blog_item m-top-30">
                                    <div class="blog_item_img">
                                        <img src="./Resources/images/blog/5.jpg" alt="" />
                                    </div>
                                    <ol class="breadcrumb">
                                        <li><a href="#" class="text-black">Fashion</a></li>
                                        <li><a href="#" class="text-black">Feb 28th 2015</a></li>
                            ...
                            <div class="col-md-4">
                                <div class="blog_item m-top-30">
                                    <div class="blog_item_img">
                                        <img src="./Resources/images/blog/8.jpg" alt="" />
                                    </div>
                                    <ol class="breadcrumb">
                                        <li><a href="#" class="text-black">Fashion</a></li>
                                        <li><a href="#" class="text-black">Feb 28th 2015</a></li>
                            ...
                            <div class="col-md-4">
                                <div class="blog_item m-top-30">
                                    <div class="blog_item_img">
                                        <img src="./Resources/images/blog/9.jpg" alt="" />
                                    </div>
                                    <ol class="breadcrumb">
                                        <li><a href="#" class="text-black">Fashion</a></li>
                                        <li><a href="#" class="text-black">Feb 28th 2015</a></li>
