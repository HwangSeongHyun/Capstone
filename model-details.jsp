                        ...
                        <div class="main_details">
                            <div class="col-md-6">
                                <div class="m_details_img">
                                    <img src="./Resources/images/angela-img.jpg" alt="" />
                                </div>
                            </div>
                            <div class="col-md-6">
                                    ...
                                    <div class="item active testimonial_item">
                                        <div class="col-sm-10 col-sm-offset-1">
                                            ...
                                            <div class="test_authour">
                                                <img class="img-circle" src="./Resources/images/test-img.jpg" alt="" />
                        ...
                        <div class="main_cbrand text-center">
                            <div class="col-md-2 col-sm-4 col-xs-6">
                                <div class="cbrand_item m-bottom-10">
                                    <a href=""><img src="./Resources/images/brand-img1.png" alt="" /></a>
                                </div>
                            </div>
                            <div class="col-md-2 col-sm-4 col-xs-6">
                                <div class="cbrand_item m-bottom-10">
                                    <a href=""><img src="./Resources/images/brand-img2.png" alt="" /></a>
                                </div>
                            </div>
                            <div class="col-md-2 col-sm-4 col-xs-6">
                                <div class="cbrand_item m-bottom-10">
                                    <a href=""><img class="" src="./Resources/images/brand-img3.png" alt="" /></a>
                                </div>
                            </div>
                            <div class="col-md-2 col-sm-4 col-xs-6">
                                <div class="cbrand_item m-bottom-10">
                                    <a href=""><img src="./Resources/images/brand-img4.png" alt="" /></a>
                                </div>
                            </div>
                            <div class="col-md-2 col-sm-4 col-xs-6">
                                <div class="cbrand_item m-bottom-10">
                                    <a href=""><img src="./Resources/images/brand-img5.png" alt="" /></a>
                                </div>
                            </div>
                            <div class="col-md-2 col-sm-4 col-xs-6">
                                <div class="cbrand_item m-bottom-10">
                        ...
                        <div class="main-gallery roomy-80">
                            ...
                            <div class="grid text-center">
                                <div class="grid-item transition metal ium">
                                    <img alt="" src="./Resources/images/porfolio-1.jpg">
                                </div><!-- End off grid item -->

                                <div class="grid-item metalloid " >
                                    <img alt="" src="./Resources/images/porfolio-2.jpg">
                                </div><!-- End off grid item -->

                                <div class="grid-item post-transition metal numberGreaterThan50">
                                    <img alt="" src="./Resources/images/porfolio-3.jpg">
                                </div><!-- End off grid item -->

                                <div class="grid-item post-transition metal ium" >
                                    <img alt="" src="./Resources/images/porfolio-4.jpg">
                                </div><!-- End off grid item -->

                                <div class="grid-item metal ar" >
                                    <img alt="" src="./Resources/images/porfolio-5.jpg">
                                </div><!-- End off grid item -->

                                <div class="grid-item alkali ar" >
                                    <img alt="" src="./Resources/images/porfolio-6.jpg">
                                </div><!-- End off grid item -->
