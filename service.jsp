                                    ...
                                    <div class="row">
                                        <div class="col-md-3 col-sm-6">
                                            <div class="sv_feature_item sm-m-top-20">
                                                <img src="./Resources/images/s-team-img1.jpg" alt="" />
                                                <h6 class="m-top-20">Fashionista</h6>
                                            </div>
                                        </div>
                                        <div class="col-md-3 col-sm-6">
                                            <div class="sv_feature_item sm-m-top-20">
                                                <img src="./Resources/images/s-team-img2.jpg" alt="" />
                                                <h6 class="m-top-20">Model Photo</h6>
                                            </div>
                                        </div>
                                        <div class="col-md-3 col-sm-6">
                                            <div class="sv_feature_item sm-m-top-20">
                                                <img src="./Resources/images/s-team-img3.jpg" alt="" />
                                                <h6 class="m-top-20">Catwalk</h6>
                                            </div>
                                        </div>
                                        <div class="col-md-3 col-sm-6">
                                            <div class="sv_feature_item sm-m-top-20">
                                                <img src="./Resources/images/s-team-img4.jpg" alt="" />
