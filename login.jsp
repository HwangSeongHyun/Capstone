                    ...
                    <div class="row">
                        <div class="main_contact p-top-100 p-bottom-100">
                            ...
                            <div class="col-md-6 sm-m-top-30">
                                <form id="signup-form" class="" action="loginck.jsp">
                                    <div class="row">
                                        <div class="col-sm-12">
                                            <div class="form-group">
                                                <label>Your ID *</label>
                                                <input id="email" name="id" type="text" class="form-control" required="true" autocomplete="off">
                                            </div>
                                        </div>
                                        <div class="col-sm-12">
                                            <div class="form-group">
                                                <label>Your Password *</label>
                                                <input id="email" name="pw" type="password" class="form-control" required="true" autocomplete="off">
                                            </div>
                                        </div>
                                        <div class="form-group" align="center">
                                        	<input class="btn btn-default text-uppercase" type=submit value="&nbsp;login&nbsp;">&nbsp;&nbsp;
                                            <input class="btn btn-default text-uppercase" type=button onclick="location.href='signup.jsp'" value="sign up">
                                        </div>
                                    </div>
                                </form>
                            </div>
