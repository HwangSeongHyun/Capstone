                    ...
                    <div class="row">
                        <div class="main_contact p-top-100">
                            ...
                            <div class="col-md-6 sm-m-top-30">
                                <form id="signup-form" class="" action="modifyck.jsp" method="post" onsubmit="return signupck(this)">
                                    <div class="row">
                                        <div class="col-sm-12">
                                            <div class="form-group">
                                                <label>Your ID</label>
                                                <input id="email" name="id" type="text" class="form-control" value="<%=userid%>" disabled="">
                                            </div>
                                        </div>
                                        <div class="col-sm-12">
                                            <div class="form-group">
                                        ...
                                        <div class="col-sm-12">
                                            <div class="form-group">
                                                ...
                                                <input id="email" name="pw2" type="password" class="form-control" required="true" autocomplete="off" minlength="9">
                                            </div>
                                        </div>
										<div class="col-sm-12">
                                            <div class="form-group"> 
                                                <label>Your Name</label>
                                                <input id="first_name" name="nm" type="text" class="form-control" value="<%=name%>" disabled="">
                                            </div>
										...
										<div class="col-sm-12">
                                            <div class="form-group">
                                                ...
                                                <input id="email" name="ph" type="text" class="form-control" value="<%=phone%>"  required="true" autocomplete="off" minlength="12">
                                            </div>
                                        </div>
                                        <br><br>
                                        <div class="form-group" align="center">
                                            <input class="btn btn-default text-uppercase" type="submit" value="modify confirm">
                                        </div>
                                    </div>
                                </form>
                            </div>
